...
var yjSharejs = {
    ...
    getQrCode: function getQrCode(qrCodeData) {
        ...
        qrCodeEle.innerHTML = "";
        var qr2 = new _qrcode2.default(qrCodeEle, {
            width: 120,
            height: 120
        });
    ...
    initWeixinJsSdk: function initWeixinJsSdk(signInfo) {
        ...
        function startweixin() {
            ...
            _weixinJsSdk2.default.ready(function () {
                ...
                _weixinJsSdk2.default.onMenuShareTimeline(paramsTimeline);
                _weixinJsSdk2.default.onMenuShareAppMessage(paramsAppMessage);
            });
        }
    },
